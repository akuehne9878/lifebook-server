sap.ui.define(
  ...
  function (BaseController, RestModel, jQuery, MessageBox, JSONModel, MessageToast, Fragment, Controller, Log) {
    return BaseController.extend("lifebook.view.main.detail.attachments.copy.Copy", {
      ...
      onSave: function (oEvent) {
        ...
        var that = this;
        oRestModel.copyFile({ src: srcPath, dst: dstPath, fileName: this.getOwnerComponent().getModel("currAttachment").getProperty("/name") }).then(function (data) {
